error id: file:///C:/Users/user/Desktop/12x12/timeTracker/src/main/java/com/timeTracker/auth/MagicLinkService.java:_empty_/User#
...
public class MagicLinkService {
    ...
    public MagicLinkService(UserRepository userRepo, LoginTokenRepo tokenRepo) {
        this.userRepo = userRepo;
        this.tokenRepo = tokenRepo;
    }
    public String createMagicLink(String email) {
    User user = userRepo.findByEmail(email.toLowerCase().trim())
        .orElseGet(() -> userRepo.save(new Use@@r(UUID.randomUUID(), email)));
